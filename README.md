...
> Данная версия развивается независимо от оригинального проекта MagiTrickle. НО при этом на текущий момент происходят регулярные слияния (merge) с оригинальным проектом.
